...
abstract class AdRepository {
  ...
  Future<Either<Failure, void>> toggleStartupAdStatus(String adId, bool isActive);
  ...
  Future<Either<Failure, void>> toggleBannerAdStatus(String bannerId, bool isActive);
}
