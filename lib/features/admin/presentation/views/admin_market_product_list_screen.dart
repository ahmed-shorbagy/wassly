...
class AdminMarketProductListScreen extends StatefulWidget {
  const AdminMarketProductListScreen({super.key});

  @override
  State<AdminMarketProductListScreen> createState() =>
      _AdminMarketProductListScreenState();
}

class _AdminMarketProductListScreenState
    extends State<AdminMarketProductListScreen> {
  ...
  void _loadProducts() {
    context.read<MarketProductCubit>().loadAllMarketProducts();
  }
          ...
          Expanded(
            child: BlocConsumer<MarketProductCubit, MarketProductState>(
              ...
              builder: (context, state) {
                ...
                if (state is MarketProductError) {
                ...
                if (state is MarketProductLoaded) {
  ...
  Widget _buildProductList(
    List<MarketProductEntity> products,
                ...
                Expanded(
                  child: Row(
                    children: [
                      ...
                      Text(
                        product.isAvailable ? l10n.productAvailable : l10n.productUnavailable,
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              l10n.startByAddingYourFirstMarketProduct,
  ...
  void _toggleAvailability(String productId, bool isAvailable) {
    context.read<MarketProductCubit>().toggleAvailability(productId, isAvailable);
  }

  void _showDeleteDialog(MarketProductEntity product, AppLocalizations l10n) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              context.read<MarketProductCubit>().deleteMarketProduct(product.id);
            },
