...
class AdminAddBannerAdScreen extends StatefulWidget {
  const AdminAddBannerAdScreen({super.key});

  @override
  State<AdminAddBannerAdScreen> createState() => _AdminAddBannerAdScreenState();
}

class _AdminAddBannerAdScreenState extends State<AdminAddBannerAdScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    context.read<AdManagementCubit>().addBannerAd(
      imageUrl: '',
