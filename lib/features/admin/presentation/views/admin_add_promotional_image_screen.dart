...
class AdminAddPromotionalImageScreen extends StatefulWidget {
  const AdminAddPromotionalImageScreen({super.key});

  @override
  State<AdminAddPromotionalImageScreen> createState() =>
      _AdminAddPromotionalImageScreenState();
}

class _AdminAddPromotionalImageScreenState
    extends State<AdminAddPromotionalImageScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    context.read<AdManagementCubit>().addPromotionalImage(
      imageUrl: '',
  ...
  Widget build(BuildContext context) {
    ...
    return SafeNavigationWrapper(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(l10n.addPromotionalImage),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text(l10n.addPromotionalImage),
                    ),
                  ],
                ),
              ),
