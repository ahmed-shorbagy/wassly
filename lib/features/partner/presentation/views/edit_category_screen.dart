...
class PartnerEditCategoryScreen extends StatefulWidget {
  final String restaurantId;
  final String categoryId;

  const PartnerEditCategoryScreen({
    super.key,
  ...
  @override
  State<PartnerEditCategoryScreen> createState() =>
      _PartnerEditCategoryScreenState();
}

class _PartnerEditCategoryScreenState extends State<PartnerEditCategoryScreen> {
