...
class PartnerCategoryListScreen extends StatelessWidget {
  final String restaurantId;

  const PartnerCategoryListScreen({super.key, required this.restaurantId});
                ...
                PopupMenuItem(
                  ...
                  onTap: () {
                    Future.delayed(const Duration(milliseconds: 100), () {
                      context.push(
                        '/restaurant/categories/${category.id}/edit',
                        extra: {'restaurantId': restaurantId},
                      );
                    });
                  },
