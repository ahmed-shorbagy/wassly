...
class PartnerAddCategoryScreen extends StatefulWidget {
  final String restaurantId;

  const PartnerAddCategoryScreen({
    super.key,
    required this.restaurantId,
  });

  @override
  State<PartnerAddCategoryScreen> createState() => _PartnerAddCategoryScreenState();
}

class _PartnerAddCategoryScreenState extends State<PartnerAddCategoryScreen> {
